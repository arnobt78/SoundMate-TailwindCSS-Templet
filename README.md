...
## SoundMate-TailwindCSS-Templet

SoundMate-TailwindCSS-Templet is a Static React Frontend Landing Page with header logo, navbar, body with info, button, cards, footer and responsive screen for any device where using only TailwindCSS, Tailwind class extension JS and HTML.
